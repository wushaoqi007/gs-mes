...
public class DataScopeAspect {
    ...
    public void doBefore(JoinPoint point, DataScopeOld controllerDataScope) throws Throwable {
        clearDataScope(point);
        handleDataScope(point, controllerDataScope);
    }

    protected void handleDataScope(final JoinPoint joinPoint, DataScopeOld controllerDataScope) {
        // 获取当前的用户
