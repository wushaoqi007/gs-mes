package com.greenstone.mes.common.security.auth;

import com.greenstone.mes.common.core.exception.auth.NotLoginException;
...
import com.greenstone.mes.common.security.annotation.Logical;
...
//        }
    ...
    public void checkPermiAnd(String... permissions) {
        Set<UserPermissionResult> permissionList = getPermiList();
...
//            }
    ...
    public void checkPermiOr(String... permissions) {
        Set<UserPermissionResult> permiList = getPermiList();
        for (String permission : permissions) {
...
//            }
     ...
     * @return 权限列表
     */
    public Set<UserPermissionResult> getPermiList() {
        try {
            LoginUser loginUser = getLoginUser();
