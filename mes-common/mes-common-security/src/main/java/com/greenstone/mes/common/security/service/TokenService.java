package com.greenstone.mes.common.security.service;

import com.greenstone.mes.common.core.constant.CacheConstants;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUser loginUser) {
        if (loginUser == null || loginUser.getUser() == null ||
                loginUser.getUser().getUserId() == null || loginUser.getUser().getUserName() == null) {
    ...
    public LoginUser getLoginUser(String token) {
        ...
        try {
            ...
            log.error("Get login user fail: {}", e.getMessage(), e);
        }
        return user;
    }
