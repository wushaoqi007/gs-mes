...
public interface SysUserService extends IService<SysUser> {
    ...
    List<SysUser> allUsers(SysUser user);
    ...
    SysUser getNickNameByUserName(String userName);

    List<Long> getUserIds();

    SysUser selectUserByWxUserId(String wxUserId);

    SysUser getSysUser(SysUser user);

    List<SysUser> getSysUsers(SysUser user);

    void updateUserByWxOauth2(String code, String state);
}
