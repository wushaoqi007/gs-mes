...
import com.greenstone.mes.system.infrastructure.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public List<SysDictData> selectDictDataByType(String dictType)
    {
        ...
        dictDatas = TreeUtils.toTree(dictDataMapper.selectDictDataByType(dictType));
        if (StringUtils.isNotEmpty(dictDatas))
        {
    ...
    public void loadingDictCache()
    {
        ...
        {
            List<SysDictData> dictDatas = TreeUtils.toTree(dictDataMapper.selectDictDataByType(dictType.getDictType()));
    ...
    public int updateDictType(SysDictType dict)
    {
        ...
        if (row > 0)
        {
            List<SysDictData> dictDatas = TreeUtils.toTree(dictDataMapper.selectDictDataByType(dict.getDictType()));
