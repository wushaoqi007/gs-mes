...
@NoArgsConstructor
@AllArgsConstructor
public class ApprovalTemporaryChange {
    ...
    public static ApprovalTemporaryChange from(CpId cpId, String userName, WxCpApprovalDetailResult.WxCpApprovalDetail approvalDetail) {
        String reason = ApprovalAssemblerHelper.getContent(approvalDetail, ContentType.TEXTAREA, "变更事由");
        ...
        return ApprovalTemporaryChange.builder().cpId(cpId).spNo(new SpNo(approvalDetail.getSpNo()))
