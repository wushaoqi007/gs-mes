...
public class ApprovalFinish {
    ...
    public static ApprovalFinish from(CpId cpId, String userName, WxCpApprovalDetailResult.WxCpApprovalDetail approvalDetail) {
        String serialNo = ApprovalAssemblerHelper.getContent(approvalDetail, ContentType.Text, "关联出库单");
        Date takeTime = ApprovalAssemblerHelper.getContent(approvalDetail, ContentType.DATE, "日期");
        ApprovalMembers takeBys = ApprovalAssemblerHelper.getContent(approvalDetail, ContentType.Contact, "领用人");
        ...
        return ApprovalFinish.builder().cpId(cpId).spNo(new SpNo(approvalDetail.getSpNo()))
