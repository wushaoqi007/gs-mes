...
@NoArgsConstructor
@AllArgsConstructor
public class ApprovalCheckedTake {
    ...
    public static ApprovalCheckedTake from(CpId cpId, String userName, WxCpApprovalDetailResult.WxCpApprovalDetail approvalDetail) {
        ...
        return ApprovalCheckedTake.builder().cpId(cpId).spNo(new SpNo(approvalDetail.getSpNo()))
