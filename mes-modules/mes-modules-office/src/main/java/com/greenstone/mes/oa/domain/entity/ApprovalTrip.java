...
public class ApprovalTrip {
    ...
    public static ApprovalTrip from(CpId cpId, String userName, WxCpApprovalDetailResult.WxCpApprovalDetail approvalDetail) {
        ...
        return ApprovalTrip.builder().cpId(cpId).spNo(new SpNo(approvalDetail.getSpNo()))
