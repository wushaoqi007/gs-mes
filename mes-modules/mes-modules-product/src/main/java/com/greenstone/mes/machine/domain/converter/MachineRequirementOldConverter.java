...
public interface MachineRequirementOldConverter {

    // MachineRequirement
    @Mapping(target = "id", source = "requirementDO.id")
    @Mapping(target = "serialNo", source = "requirementDO.serialNo")
    @Mapping(target = "projectCode", source = "requirementDO.projectCode")
    @Mapping(target = "confirmBy", source = "requirementDO.confirmBy")
    @Mapping(target = "confirmTime", source = "requirementDO.confirmTime")
    @Mapping(target = "remark", source = "requirementDO.remark")
    @Mapping(target = "parts", source = "detailDOS")
    MachineRequirement toMachineRequirement(MachineRequirementDO requirementDO, List<MachineRequirementDetailDO> detailDOS);
